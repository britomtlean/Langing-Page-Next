...
import prisma from '../../_db/prisma'; //IMPORTAÇÃO DE INSTANCIA PRISMA
  ...
  return (
      <main className="min-h-screen bg-blue-950 py-12 px-4">
          <div className="mx-auto max-w-7xl">
              <h1 className="mb-10 text-center text-4xl font-bold text-white">Mais Vendidos</h1>
                  ...
                  {produtos.map((produto: any) => (
                      ...
                      >
                          ...
                          <div className="space-y-3 p-5">
                              ...
                              <button className="mt-2 w-full rounded-xl bg-red-700 py-3 font-semibold text-white transition hover:bg-red-600 active:scale-95">
                                  Ver Produto
                              </button>
                          </div>
                      </div>
