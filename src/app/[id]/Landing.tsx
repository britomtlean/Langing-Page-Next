...
export default function Landing({ user }: { user: Usuarios | null }) {
        ...
        <main className="relative pt-[15%] md:p-0 min-h-screen flex flex-col gap-8 items-center justify-start md:justify-center overflow-hidden bg-blue-900/30 text-white">
            ...
            >
                ...
                <div className="mt-6 flex flex-col gap-3">
                    <LinkButton href={`/${user?.user}/catalogo`}>
                    ...
                    <LinkButton href={`https://wa.me/${user?.WhatsApp}`}>
                        <div className="flex justify-center items-center gap-4">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                    ...
                    <LinkButton href={'https://www.instagram.com/' + user?.Instagram}>
                        <div className="flex justify-center items-center gap-4">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
